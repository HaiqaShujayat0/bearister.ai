        ...
        <div className="bg-slate-800 rounded-2xl p-8 text-center">
          ...
          {status === "success" && (
            <div>
              ...
              <Link to="/signin">
                <Button className="w-full bg-orange-500 hover:bg-orange-600 text-white">Sign In Now</Button>
              </Link>
            </div>
          )}
          ...
          {status === "error" && (
            <div>
              ...
              <div className="space-y-3">
                ...
                <Link to="/signin">
                  <Button className="w-full bg-orange-500 hover:bg-orange-600 text-white">Back to Sign In</Button>
                </Link>
              </div>
            </div>
          )}
